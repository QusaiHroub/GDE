...
namespace Desktop {
    ...
    DesktopFile::DesktopFile(const QString &path)
        ...
        m_crashCountSupported =
            getBool(desktopHeader, QStringLiteral("X-ADE-Support-Crash-Param"));
    ...
    void DesktopFile::resolveAutostartConditions() {
        ...
        QString desktopAutostartPhase =
            getString(desktopHeader, QStringLiteral("X-ADE-Autostart-Phase"));
        ...
        m_autostartDelay = getInt(desktopHeader, QStringLiteral("X-ADE-Autostart-Delay"));
    ...
    const QString &DesktopFile::exec() {
        return m_exec;
    }

    const QStringList &DesktopFile::args() {
        return m_args;
    }
